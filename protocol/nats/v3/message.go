...
func (m *MsgAdapter) Data() []byte {
	return m.orig.Data
}

func (m *MsgAdapter) Headers() nats.Header {
	return m.orig.Header
}

func (m *MsgAdapter) Subject() string {
	return m.orig.Subject
}

func (m *MsgAdapter) Ack() error {
	return m.orig.Ack()
}
func (m *MsgAdapter) Nak() error {
	return m.orig.Nak()
}

func NewMsgAdapter(msg nats.Msg) NatsMsg {
	return &MsgAdapter{orig: msg}
}
...
func NewMessage(msg NatsMsg) *Message {
